...
The design rationale, in prose. This was the body of `README.md` until the README
became a quick start; nothing here has been rewritten, only moved.

For **how to run it**, see [README.md](README.md). For **what happens on one run**,
step by step, see [WALKTHROUGH.md](WALKTHROUGH.md).
...
app/
  ...
  cli.py          headless run
tests/            318 tests, no API key needed
